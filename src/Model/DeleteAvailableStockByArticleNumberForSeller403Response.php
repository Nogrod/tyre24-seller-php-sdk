<?php
/**
 * DeleteAvailableStockByArticleNumberForSeller403Response
 *
 * PHP version 8.1
 *
...
/**
 * DeleteAvailableStockByArticleNumberForSeller403Response Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DeleteAvailableStockByArticleNumberForSeller403Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'deleteAvailableStockByArticleNumberForSeller_403_response';
    ...
    protected static array $openAPITypes = [
        'data' => '\Tyre24\Seller\Model\AccessControlErrorResponse'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Tyre24\Seller\Model\AccessControlErrorResponse|null
     */
    public function getData(): ?\Tyre24\Seller\Model\AccessControlErrorResponse
    {
     ...
     * Sets data
     *
     * @param \Tyre24\Seller\Model\AccessControlErrorResponse|null $data data
     *
     * @return $this
     */
    public function setData(?\Tyre24\Seller\Model\AccessControlErrorResponse $data): static
    {
        if (is_null($data)) {
