...
/**
 * OENArticleRequest Class Doc Comment
 *
 ...
 */
class OENArticleRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OENArticleRequest';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The product type, so `POE` or `PUP` for this type.
     *
     * @return $this
     */
