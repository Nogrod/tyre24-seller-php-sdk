...
/**
 * ModelPaymentStatusUpdate Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ModelPaymentStatusUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ModelPaymentStatusUpdate';
    ...
    */
     ...
     * Sets payment_status
     *
     * @param int $payment_status The payment status. Possible values: 0 (unpaid) or 1 (paid).
     *
     * @return $this
     */
    public function setPaymentStatus(int $payment_status): static
    {
