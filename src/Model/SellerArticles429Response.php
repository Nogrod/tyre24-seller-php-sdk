...
/**
 * SellerArticles429Response Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SellerArticles429Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'seller_articles_429_response';
    ...
    protected static array $openAPITypes = [
        'data' => '\Tyre24\Seller\Model\B2bFormError'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Tyre24\Seller\Model\B2bFormError|null
     */
    public function getData(): ?\Tyre24\Seller\Model\B2bFormError
    {
     ...
     * Sets data
     *
     * @param \Tyre24\Seller\Model\B2bFormError|null $data data
     *
     * @return $this
     */
    public function setData(?\Tyre24\Seller\Model\B2bFormError $data): static
    {
        if (is_null($data)) {
