...
class ArticlesApi
{
    ...
    public function deleteAvailableStockByArticleNumberForSeller(
        ...
        list($response) = $this->deleteAvailableStockByArticleNumberForSellerWithHttpInfo($country, $article_type, $article_id, $customer_article_id, $manufacturer_number, $manufacturer_name, $brand_id, $ean, $oen, $contentType);
        return $response;
    }
    ...
    public function updateAvailableStockByArticleNumberForSeller(
        ...
        list($response) = $this->updateAvailableStockByArticleNumberForSellerWithHttpInfo($country, $request_stock_update, $contentType);
        return $response;
    }
