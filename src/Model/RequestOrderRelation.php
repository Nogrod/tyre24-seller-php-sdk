...
/**
 * RequestOrderRelation Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RequestOrderRelation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RequestOrderRelation';
    ...
    */
     ...
     * Sets order
     *
     * @param string $order Internal identification number of the order
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string $country The submitted country, 2 letter iso-code lower case
     *
     * @return $this
     */
