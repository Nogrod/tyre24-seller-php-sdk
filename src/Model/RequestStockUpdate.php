...
/**
 * RequestStockUpdate Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RequestStockUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RequestStockUpdate';
    ...
    */
     ...
     * Sets article_type
     *
     * @param string $article_type Article type. For a full list of available types, please refer to the endpoint `/common/article-types`.
     *
     * @return $this
     */
     ...
     * Sets article_id
     *
     * @param int|null $article_id Article id.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $customer_article_id Original customer article id.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $manufacturer_number The manufacturer number (valid if used with either the manufacturer name or the the brand id).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $manufacturer_name The manufacturer name (valid if used with the manufacturer number).
     *
     * @return $this
     */
     ...
     * Sets brand_id
     *
     * @param int|null $brand_id The brand id (valid if used with the manufacturer number).
     *
     * @return $this
     */
     ...
     * Sets ean
     *
     * @param string|null $ean The article EAN.
     *
     * @return $this
     */
     ...
     * Sets oen
     *
     * @param string|null $oen The article OEN.
     *
     * @return $this
     */
