...
/**
 * ModelStatusUpdate Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ModelStatusUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ModelStatusUpdate';
    ...
    */
     ...
     * Sets comment
     *
     * @param string|null $comment The comment associated to the status update action. For a given subset of the available status ids, a comment will be required.
     *
     * @return $this
     */
