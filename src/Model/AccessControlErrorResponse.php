...
/**
 * AccessControlErrorResponse Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccessControlErrorResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AccessControlErrorResponse';
    ...
    */
     ...
     * Sets error
     *
     * @param string|null $error The authentication error code.
     *
     * @return $this
     */
