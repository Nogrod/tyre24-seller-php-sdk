...
class ArticlesApi
{
    ...
    /**
     * Operation sellerArticles
     *
     * Update stocks and prices
     *
     * @param  \Tyre24\Seller\Model\ArticlesRequest|null $articles_request articles_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sellerArticles'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return object|\Tyre24\Seller\Model\SellerArticles422Response|\Tyre24\Seller\Model\SellerArticles429Response|\Tyre24\Seller\Model\SellerArticles401Response
     */
    public function sellerArticles(
        ?\Tyre24\Seller\Model\ArticlesRequest $articles_request = null,
        string $contentType = self::contentTypes['sellerArticles'][0]
    ): array|\Tyre24\Seller\Model\SellerArticles422Response|\Tyre24\Seller\Model\SellerArticles429Response|\Tyre24\Seller\Model\SellerArticles401Response {
        list($response) = $this->sellerArticlesWithHttpInfo($articles_request, $contentType);
        return $response;
    }

    /**
     * Operation sellerArticlesWithHttpInfo
     *
     * Update stocks and prices
     *
     * @param  \Tyre24\Seller\Model\ArticlesRequest|null $articles_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sellerArticles'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of object|object|object|\Tyre24\Seller\Model\SellerArticles422Response|\Tyre24\Seller\Model\SellerArticles429Response|\Tyre24\Seller\Model\SellerArticles401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function sellerArticlesWithHttpInfo(
        ?\Tyre24\Seller\Model\ArticlesRequest $articles_request = null,
        string $contentType = self::contentTypes['sellerArticles'][0]
    ): array {
        $request = $this->sellerArticlesRequest($articles_request, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                ...
                case 422:
                    return $this->handleResponseWithDataType(
                        '\Tyre24\Seller\Model\SellerArticles422Response',
                        $request,
                        $response,
                    );
                case 429:
                    return $this->handleResponseWithDataType(
                        '\Tyre24\Seller\Model\SellerArticles429Response',
                        $request,
                        $response,
                    );
                case 401:
     ...
     */
    public function sellerArticlesAsync(
        ?\Tyre24\Seller\Model\ArticlesRequest $articles_request = null,
        string $contentType = self::contentTypes['sellerArticles'][0]
    ): PromiseInterface {
        return $this->sellerArticlesAsyncWithHttpInfo($articles_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sellerArticlesAsyncWithHttpInfo
     *
     * Update stocks and prices
     *
     * @param  \Tyre24\Seller\Model\ArticlesRequest|null $articles_request (optional)
     ...
     * @return PromiseInterface
     */
    public function sellerArticlesAsyncWithHttpInfo(
        ?\Tyre24\Seller\Model\ArticlesRequest $articles_request = null,
        string $contentType = self::contentTypes['sellerArticles'][0]
    ): PromiseInterface {
        $returnType = 'object';
    ...
    /**
     * Create request for operation 'sellerArticles'
     *
     * @param  \Tyre24\Seller\Model\ArticlesRequest|null $articles_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sellerArticles'] to see the possible values for this operation
     *
     ...
     */
    public function sellerArticlesRequest(
        ?\Tyre24\Seller\Model\ArticlesRequest $articles_request = null,
        string $contentType = self::contentTypes['sellerArticles'][0]
    ): Request {
        ...
        // for model (json/xml)
        if (isset($articles_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($articles_request));
            } else {
                $httpBody = $articles_request;
            }
