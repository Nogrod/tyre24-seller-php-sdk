...
/**
 * RequestInvoiceinformation Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RequestInvoiceinformation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RequestInvoiceinformation';
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Internal identification number of the invoice
     *
     * @return $this
     */
     ...
     * Sets sum
     *
     * @param float $sum Total sum of the invoice
     *
     * @return $this
     */
