...
/**
 * B2bFormError Class Doc Comment
 *
 * @package  Tyre24\Seller
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class B2bFormError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'B2bFormError';
    ...
    */
     ...
     * Sets error_code
     *
     * @param string $error_code Generic error code
     *
     * @return $this
     */
     ...
     * Sets error_message
     *
     * @param string $error_message Translation of error code
     *
     * @return $this
     */
